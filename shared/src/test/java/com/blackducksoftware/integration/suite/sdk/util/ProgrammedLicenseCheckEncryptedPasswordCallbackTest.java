...
public class ProgrammedLicenseCheckEncryptedPasswordCallbackTest {
    ...
    public void testPasswordCallback() throws Exception {
        ProgrammedLicenseCheckEncryptedPasswordCallback programmedCallback = new ProgrammedLicenseCheckEncryptedPasswordCallback();
        programmedCallback.addUserNameAndPassword("testUser", encryptedUserPassword.getProperty("super"));

        Field passwordCacheField = ProgrammedLicenseCheckEncryptedPasswordCallback.class.getSuperclass().getDeclaredField("passwordCache");
    ...
    @Test
    public void testPasswordCallbackAgain() throws Exception {
        ProgrammedLicenseCheckEncryptedPasswordCallback programmedCallback = new ProgrammedLicenseCheckEncryptedPasswordCallback();
