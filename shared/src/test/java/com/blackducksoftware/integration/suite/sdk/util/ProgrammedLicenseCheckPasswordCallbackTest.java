...
public class ProgrammedLicenseCheckPasswordCallbackTest {
    ...
    public void testPasswordCallback() throws Exception {
        ProgrammedLicenseCheckPasswordCallback programmedCallback = new ProgrammedLicenseCheckPasswordCallback();
        programmedCallback.addUserNameAndPassword("testUser", "testPassword");

        Field passwordCacheField = ProgrammedLicenseCheckPasswordCallback.class.getSuperclass().getDeclaredField("passwordCache");
