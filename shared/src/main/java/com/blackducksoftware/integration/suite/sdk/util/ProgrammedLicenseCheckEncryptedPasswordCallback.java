...
public class ProgrammedLicenseCheckEncryptedPasswordCallback extends ProgrammedPasswordCallback {
    ...
    public ProgrammedLicenseCheckEncryptedPasswordCallback() throws InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException,
    ...
    protected void setPassword(WSPasswordCallback pc, String username) throws IOException {
        ...
        try {
            ...
            if (StringUtils.isEmpty(license)) {
                ...
                // pc.setPassword("DYNAM" + license + "#" +
                pc.setPassword(license + "#" + PasswordDecrypter.decrypt(getPasswordCache().get(username)));
            }
